...
export function registerUrlBuilder(app: App, runtimeContext: FrontendRuntimeContext): void {
...
export function useUrlBuilder(): UrlBuilder {
    ...
    if (!builder) {
        throw new Error('URL builder is not registered on the Vue application.');
    }
