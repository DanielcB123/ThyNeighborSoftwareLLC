        ...
        const navigation: readonly NavigationItem[] = [
            {
                id: 'dashboard',
                label: 'Dashboard',
                target: { kind: 'internal', surface: 'tenant-admin', path: '/overview' },
            },
            {
                id: 'dispatch',
                label: 'Dispatch',
                target: { kind: 'internal', surface: 'tenant-admin', path: '/dispatch' },
                access: { allModules: ['dispatch'], allPermissions: ['dispatch.view'] },
            },
            {
                id: 'billing',
                label: 'Billing',
                target: { kind: 'internal', surface: 'tenant-admin', path: '/billing' },
