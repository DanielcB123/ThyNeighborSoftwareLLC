...
class OnboardingSession extends CentralModel
{
    ...
    /**
     * @return BelongsTo<OnboardingAppointment, $this>
     */
    public function onboardingAppointment(): BelongsTo
    {
        return $this->belongsTo(OnboardingAppointment::class, 'onboarding_appointment_id');
    }
